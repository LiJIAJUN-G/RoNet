...
python test_vp4.py \
  ...
  --out_dir out_test_vp4 \
  --checkpoint /media/server/DATA/lijiajun/project/Rotavirus/02_Model/03_VP4_VP7/VP4_Final_Model/output_8M_pretraining/VP4/final_run/best_model/pytorch_model.bin \
  --id_col Sample_ID \
  --seq_col VP4_aa \
  --num_labels 5 \
  --batch_size 16 \
